            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative"> 
                    <iframe
                        ...
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7977.764793052426!2d36.7458497435105!3d-1.2410515169289698!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f185c74b13523%3A0x1246629a6e3fe844!2sLower%20Kabete!5e0!3m2!1sen!2ske!4v1644054886536!5m2!1sen!2ske"
                    />
                    ...
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        ...
                        <div className="lg:w-3/5 px-6 mt-4 lg:mt-0">
                            ...
                            <a className="text-indigo-400 leading-relaxed">
                                mwendafredrick31@email.com
                            </a>
                            <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                                PHONE
                            </h2>
                            <p className="leading-relaxed">0713723353</p>
                        </div>
                    </div>
